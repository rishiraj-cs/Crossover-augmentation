function [randmatrixcross] = genKeyblock_rw(im1,im2)
...
randmatrixcross2=randi([1, c1],r1,1); %Random values are geenrated b/w 0 to c1 and stored in 2nd column of randmatrix
