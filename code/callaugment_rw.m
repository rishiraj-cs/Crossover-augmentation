...
[randmatrixcross] = genKey_rw(Frame1, Frame2);
%[randmatrixmut] = genKeymutVid(Frame1); 
midFrame = numFrames/2; 
tempFrame = midFrame+1; 
outputFolder='/Users/rishiraj/Documents/Db-Brain-Tumor-All-Augmentations/Db-brain-tumor-jpeg-crossover-rw/glioma-jpeg-crossover-rw';
for frame = 1 : midFrame
    ...
    [img1, img2, success] = cross_rw(im1, im2, randmatrixcross, frame, tempFrame); 
