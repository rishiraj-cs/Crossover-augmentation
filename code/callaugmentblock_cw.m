...
[randmatrixcross] = genKeyblock_cw(Frame1, Frame2);
%[randmatrixmut] = genKeymutVid(Frame1); 
midFrame = numFrames/2; 
tempFrame = midFrame+1; 
outputFolder='/Users/rishiraj/Documents/Db-Brain-Tumor-All-Augmentations/Db-brain-tumor-jpeg-crossover-cw-block/glioma-jpeg-crossover';
for frame = 1 : midFrame
    ...
    [img1, img2, success] = blockcross_cw(im1, im2, randmatrixcross, frame, tempFrame); 
