function [] = callaugmentblock_rw()
%UNTITLED2 Summary of this function goes here
%   Detailed explanation goes here
tic; 
framesLost=0; 
location = '/Users/rishiraj/Documents/Db-PH2-All-Augmentations/Db-PH2-jpeg-original/Db-PH2-atypicalNevus/*.jpeg';       %  folder in which your images exists
...
[randmatrixcross] = genKeyblock_rw(Frame1, Frame2);
%[randmatrixmut] = genKeymutVid(Frame1); 
midFrame = numFrames/2; 
tempFrame = midFrame+1; 
outputFolder='/Users/rishiraj/Documents/Db-PH2-All-Augmentations/Db-PH2-crossover-corrected/atypicalNevus-crossover';
for frame = 1 : midFrame
    ...
    [img1, img2, success] = blockcross_rw(im1, im2, randmatrixcross, frame, tempFrame); 
