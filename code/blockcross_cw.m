function [ img1, img2, success] = blockcross_cw( im1, im2, randmatrix, frame, tempFrame )
...
if(r1==r2 & c1==c2)
    ...
    for col = 1:c1
        ...
        %swapping
        mat1(col:value1,col:value2,:) = im1(col:value1,col:value2,:); 
        im1(col:value1,col:value2,:) = im2(col:value1,col:value2,:);
        im2(col:value1,col:value2,:) = mat1(col:value1,col:value2,:); 
        rowbck = rowbck-1; 
